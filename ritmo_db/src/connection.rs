...
pub async fn initialize_database(db_path: &PathBuf) -> Result<(), RitmoErr> {
    let path = db_path.join("ritmo.db");
...
pub async fn create_pool(db_path: &PathBuf, create: bool) -> Result<SqlitePool, RitmoErr> {
